...
public class HeartbeatController {
    ...
    public ResponseEntity<Map<String, Object>> getLatestHeartbeat() {
        ...
        if (lastReceivedAt == null) {
            long secondsSinceServerStart = Duration.between(heartbeatState.getServerStartedAt(), now).toSeconds();
        ...
        long secondsSinceLastHeartbeat = Duration.between(lastReceivedAt, now).toSeconds();
